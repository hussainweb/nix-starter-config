{
  ...
  system.activationScripts.extraActivation.text = ''
    ...
    mkdir -p /Users/user-name/.1password && ln -sfv /Users/user-name/Library/Group\ Containers/2BUA8C4S2C.com.1password/t/agent.sock /Users/user-name/.1password/agent.sock

    ln -sfv /Users/user-name/.config/VSCode/settings.json /Users/user-name/Library/Application\ Support/Code/User/settings.json
